...
const ChatHeader = () => {
  ...
  return (
    <div className="h-[10vh] border-b-2 p-3 border-[#2f30b] flex items-center justify-between">
      <div className="flex gap-5 items-center w-full justify-between">
        <div className="flex gap-3 items-center justify-center">
          ...
          >
            {
              selectedChatType === 'contact' ? <Avatar className="h-6 w-6 sm:mt-1 sm:h-10 sm:w-10 rounded-full overflow-hidden ">
                  {selectedChatData.image ? (
                    ...
                    <div
                      className={`uppercase h-10 w-10 mt-[6px] sm:mt-1 sm:h-10 sm:w-10 text-lg border-[3px] flex items-center justify-center rounded-full ${getcolor(
